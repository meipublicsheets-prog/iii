...
function generateBinConsolidationSuggestions() {
  ...
  // Bin_Stock columns (0-based) - matches HEADERS['Bin_Stock']
  ...
  const COL_PROJECT = 3;  // D Project
  const COL_FBPN = 5;     // F FBPN
  const COL_QTY = 8;      // I Current_Quantity
  const COL_PCT = 9;      // J Stock_Percentage
  const COL_SKU = 12;     // M SKU
